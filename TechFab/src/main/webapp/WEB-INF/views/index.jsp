        						...
        						<div id="products-tabs-content" class="row tab-content" >
									...
									<div class="col-md-4 col-sm-6 col-xs-12" ng-repeat="p in jsonData">
        								<div class="item">
											...
											<a href="wishlist-{{productdata.productId}}?userId=1" class="icon-button icon-like">Wishlist</a>
        										<a href="buynow-{{productdata.productId}}?userId=1" class="icon-button icon-compare">Buy now</a>
        								...
        								<div class="item">
        									...
        									<div class="item-meta-container">
        										...
        										<div class="item-action">
        											...
        											<div class="item-action-inner">
        												<a href="wishlist-{{productdata.productId}}?userId=1" class="icon-button icon-like">Wishlist</a>
        												<a href="buynow-{{productdata.productId}}?userId=1"" class="icon-button icon-compare">Checkout</a>
        											</div><!-- End .item-action-inner -->
        										</div><!-- End .item-action -->
        									</div><!-- End .item-meta-container -->	
        								</div><!-- End .item -->
